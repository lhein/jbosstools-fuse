...
import org.fusesource.ide.camel.model.service.core.util.versionmapper.CamelForSpringBootFuse77ToBomMapper;
...
public class CamelCatalogUtils {
	...
	public static final String CAMEL_VERSION_LATEST_COMMUNITY = "2.24.1";
	public static final String CAMEL_VERSION_LATEST_PRODUCTIZED_62 = CamelForFuse6ToBomMapper.FUSE_621_R9_CAMEL_VERSION;
	public static final String CAMEL_VERSION_LATEST_PRODUCTIZED_63 = CamelForFuse6ToBomMapper.FUSE_63_R9_CAMEL_VERSION;
	...
	static final Map<String, String> CAMEL_VERSION_2_FUSE_77_SPRINGBOOT_BOM_MAPPING = new CamelForSpringBootFuse77ToBomMapper().getMapping();
	...
	static {
		...
		OFFICIAL_SUPPORTED_CAMEL_CATALOG_VERSIONS.addAll(CAMEL_VERSION_2_FUSE_77_SPRINGBOOT_BOM_MAPPING.keySet());
	...
	public static String getBomVersionForCamelVersion(String camelVersion, IProgressMonitor monitor, org.apache.maven.model.Dependency fuseBomUsed) {
		...
		if (camelVersion != null) {
			if(fuseBomUsed != null) {
				...
				} else if(isBom(FuseBomFilter.BOM_FUSE_71_SPRINGBOOT, fuseBomUsed)) {
					bomVersion = getFuse77SpringBootBomVersion(camelVersion, fuseBomUsed, monitor);
				}
			}
		} else {
			return null;
	...
	private static String getFuse77SpringBootBomVersion(String camelVersion, org.apache.maven.model.Dependency fuseBomUsed, IProgressMonitor monitor) {
		if (CAMEL_VERSION_2_FUSE_77_SPRINGBOOT_BOM_MAPPING.containsKey(camelVersion)) {
			return CAMEL_VERSION_2_FUSE_77_SPRINGBOOT_BOM_MAPPING.get(camelVersion);
		} else if (CAMEL_VERSION_2_FUSE_71_BOM_MAPPING.containsKey(camelVersion)) {
